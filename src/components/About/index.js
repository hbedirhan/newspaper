    ...
    <div>
        <section>
            <div className="cv-container">
                <div className="cv-container-box1">
                <h2>Bedirhan Harputluoğlu | Front-End Developer</h2>
                <div className="cv-img">
                    <img src="https://media.licdn.com/dms/image/D4D03AQGCNemh84ty8A/profile-displayphoto-shrink_800_800/0/1667217417548?e=1680739200&amp;v=beta&amp;t=VjmHBbeaVux1eYFIJ8SXiFAFCGYj0BQR_FFPXLgpEsk" alt="" width="250px" />
                </div>
                <div className="cv-nav">
                    <ul>
                    <li>
                        <a href="https://github.com/hbedirhan" target="_blank">
                    ...
                    <li>
                        <a href="https://www.linkedin.com/in/bedirhan-harputluo%C4%9Flu-534a44232/" target="_blank">
                    ...
                    <li>
                        <a href="mailto:bedirhanharputlu@gmail.com">
                ...
                <div className="cv-container-box2">
                <div className="about-text">
                    <p>Merhaba, burada react ile newsapi kullanarak gazete websitesi yapmaya çalıştım.</p>
                </div>
